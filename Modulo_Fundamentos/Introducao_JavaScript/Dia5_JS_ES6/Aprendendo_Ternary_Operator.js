//Mostrando a sintaxe da estrutura do Ternary Operator(Operador Ternário)
...
//Mostrando situações que é mais simples utilizar o Ternary Operator e tbm situação que é melhor utilizar as condicionais tradicionais IF e ELSE ou Switch e CASE!!!
...
const checkTernary2 =(fruit) => ((fruit === `maçã`) ? `Essa fruta é vermelha` : (fruit === `banana` ? `Esta fruta é amarela` : `Não sei a cor`));
console.log(checkTernary2('banana'));
